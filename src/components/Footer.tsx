        ...
        <div className="md:col-span-4">
          ...
          <div className="flex space-x-5 text-charcoal/70 items-center">
            ...
            <a href="https://wa.me/917010857596" target="_blank" rel="noopener noreferrer" className="hover:text-charcoal hover:-translate-y-1 transition-all duration-300" aria-label="WhatsApp">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-[24px] h-[24px]" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="mt-4 flex items-center gap-2 text-charcoal/80">
